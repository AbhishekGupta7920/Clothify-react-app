  ...
  return (
    <div className="mt-14 mb-12">
      <div className="container">
        ...
        {/* Body section */}
        <div>
          <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 place-items-center gap-13">
            {/* card section */}
